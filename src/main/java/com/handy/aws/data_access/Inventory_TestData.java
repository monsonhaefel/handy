...
public class Inventory_TestData implements InventoryDA {
    ...
    public Product getProductById(Integer productId, Context context) {
        ...
        if(products == null) {
            ...
            products[0] = new Product(100, "Hammer", "Stanley", "(test data) 5oz Magnetic Tack Hammer",    20);
            products[1] = new Product(101, "Hammer", "Wilton Bash", "(test data) 24oz Ball Peen",          27);
            products[2] = new Product(102, "Hammer", "DeWalt", "(test data) 15oz MIG Weld",                17);
        }
